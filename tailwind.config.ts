  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        // UI
        'ui': ['0.875rem', { lineHeight: '1.25', fontWeight: '500' }],
        'ui-sm': ['0.75rem', { lineHeight: '1.3', fontWeight: '500' }],
      },
      colors: {
      ...
      keyframes: {
        ...
        "glow-pulse": {
          "0%, 100%": { boxShadow: "0 0 20px rgba(0, 89, 255, 0.3)" },
          "50%": { boxShadow: "0 0 30px rgba(0, 89, 255, 0.5)" }
        },
        "shimmer": {
