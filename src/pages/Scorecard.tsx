  ...
  return (
    <div ref={setNodeRef} style={style} className="relative group">
      ...
      <div
        {...attributes}
        {...listeners}
        className="absolute top-4 left-4 z-10 cursor-grab active:cursor-grabbing p-2 hover:bg-secondary rounded opacity-0 group-hover:opacity-100 transition-opacity"
      >
